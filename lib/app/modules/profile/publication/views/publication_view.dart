              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    CustomTextField(hintText: 'Enter title', controller: controller.titleC),
                    const SizedBox(height: 16),
                    Text('Author(s)', style: boldText12),
                    const SizedBox(height: 8),
                    CustomTextField(hintText: 'Enter author',controller: controller.authorC),
                    const SizedBox(height: 16),
                    Text('Publication Type', style: boldText12),
                    const SizedBox(height: 8),
                    CustomTextField(hintText: 'Enter publication type',controller: controller.pubTypeC),
                    const SizedBox(height: 16),
                    Text('Publisher', style: boldText12),
                    const SizedBox(height: 8),
                    CustomTextField(hintText: 'Enter publisher',controller: controller.publisherC),
                    const SizedBox(height: 16),
